let service = require("../../utils/area.js");
...
export let AreaPicker = {
  ...
  _area_selectAreaItem(e) {
    ...
    if (level < this.data._area_level - 1) {console.log(1)
      //加载下一页地址选择数据
  ...
  _area_loadArea(level, areaId) {
    ...
    service.getNextAreaList(areaId,level).then(data => {
